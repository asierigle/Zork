...
void Init(){
	...
	map[1][2].name = "Parking\n";
	map[3][2].name = "Bus stop\n";
	map[4][0].name = "Street1\n";
	map[3][0].name = "Street2\n";
	map[1][0].name = "Street4\n";
	map[0][0].name = "Street5\n";
	map[4][1].name = "Street6\n";
	map[3][1].name = "Street7\n";
	map[1][1].name = "Street8\n";
	map[0][1].name = "Street9\n";
	map[4][2].name = "Street10\n";
	map[0][2].name = "Street11\n";
	map[4][3].name = "Street12\n";
	map[3][3].name = "Street13\n";
	map[2][3].name = "Street14\n";
	map[1][3].name = "Street15\n";
	map[0][3].name = "Street16\n";
	map[4][4].name = "Street17\n";
	map[3][4].name = "Street18\n";
	map[2][4].name = "Street19\n";
	map[1][4].name = "Street20\n";
	map[0][4].name = "Street21\n";
	...
	map[2][1].exits = "There's a Scary forest at the north.\n There are streets at east and west.\ The Awesomekitchen is at south.\n";
